...
import newsImage from "../assets/images/hero/1.jpg";
...
const NewsDetails = () => {
    ...
    return (
        <>
            ...
            />
            <section
              data-aos="fade-up"  className="dark:bg-black dark:text-white bg-white text-gray-800 transition-colors duration-300 ease-in-out pt-16 pb-[10px] md:pb-16 px-[10px] md:px-10"
            >
