...
const JobDetails = () => {
    ...
    const jobData = {
        ...
        benefits: "Festival Bonus, Contributory Provident Fund, Gratuity, Health & Life Insurance and others as per organisation policy.",
        summary: {
    ...
    return (
        <>
            <InnerHero
                ...
                backgroundImage=""
            />
            <section data-aos="fade-up" className="dark:bg-black dark:text-white bg-white text-black py-16 px-4 md:px-10 transition-colors duration-300 ease-in-out">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        <div className="lg:w-3/4">
                            <div className="bg-white text-black p-6 sm:p-8 rounded-lg shadow-lg max-w-4xl mx-auto">                   
                                ...
                                <button
                                    onClick={() => navigate(`/career/${id}/apply`)}
                        ...
                        <div className="lg:w-1/4">
                            <div className="bg-white text-sm rounded-lg p-4 shadow-md sticky top-[150px]">
                                <h3 className="text-lg text-white bg-[#c20e35] p-3 rounded-md mb-4">
                                    Job Summary
                                </h3>
                                ...
                                <div className="space-y-3 text-gray-800">
                                    <div>
                                        ...
                                        <span className="text-gray-600"> {jobData.summary.published}</span>
                                    </div>
                                    <div>
                                        <span className="font-medium">Vacancy:</span>
                                        <span className="text-gray-600"> {jobData.summary.vacancy}</span>
                                    </div>
                                    <div>
                                        <span className="font-medium">Employment Status:</span>
                                        <span className="text-gray-600"> {jobData.summary.employmentStatus}</span>
                                    </div>
                                    <div>
                                        <span className="font-medium">Experience:</span>
                                        <span className="text-gray-600"> {jobData.summary.experience}</span>
                                    </div>
                                    <div>
                                        <span className="font-medium">Age:</span>
                                        <span className="text-gray-600"> {jobData.summary.age}</span>
                                    </div>
                                    <div>
                                        <span className="font-medium">Job Location:</span>
                                        <span className="text-gray-600"> {jobData.summary.jobLocation}</span>
                                    </div>
                                    <div>
                                        <span className="font-medium">Salary:</span>
                                        <span className="text-gray-600"> {jobData.summary.salary}</span>
                                    </div>
                                    <div>
                                        <span className="font-medium">Application Deadline:</span>
                                        <span className="text-gray-600"> {jobData.summary.deadline}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
