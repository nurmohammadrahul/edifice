    ...
    const contactItems = [
        {
            icon: (
                <svg className="w-6 h-6 text-[#c20e35] mt-1 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a2 2 0 01-2.828 0l-4.243-4.243a8 8 0 1111.314 0z"></path>
        ...
        },
        {
            icon: (
                <svg className="w-6 h-6 text-[#c20e35] mt-1 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h2l2 5-2 2c1.5 3 4.5 6 7.5 7.5l2-2 5 2v2a2 2 0 01-2 2h-1c-9 0-16-7-16-16V5z"></path>
                </svg>
            ),
            title: "Phones:",
            content: (
        ...
        },
        {
            icon: (
                <svg className="w-6 h-6 text-[#c20e35] mt-1 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 4.5v15a1.5 1.5 0 01-1.5 1.5H3.75a1.5 1.5 0 01-1.5-1.5v-15A1.5 1.5 0 013.75 3h16.5a1.5 1.5 0 011.5 1.5z"></path>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6l9 7.5 9-7.5"></path>
                </svg>
            ),
            title: "Write Us:",
            content: (
